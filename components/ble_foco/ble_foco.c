...
static const esp_gatts_attr_db_t foco_gatt_db[FOCO_IDX_NB] = {
    ...
    [IDX_CHAR_COLOR_DECL] = {{ESP_GATT_AUTO_RSP}, {ESP_UUID_LEN_16, (uint8_t *)&character_declaration_uuid, ESP_GATT_PERM_READ, CHAR_DECLARATION_SIZE, CHAR_DECLARATION_SIZE, (uint8_t *)&char_prop_read_write}},
    [IDX_CHAR_COLOR_VAL] = {{ESP_GATT_AUTO_RSP}, {ESP_UUID_LEN_16, (uint8_t *)&GATTS_CHAR_UUID_COLOR, ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE, 3, sizeof(current_color), (uint8_t *)current_color}},
    [IDX_CHAR_BRILLO_DECL] = {{ESP_GATT_AUTO_RSP}, {ESP_UUID_LEN_16, (uint8_t *)&character_declaration_uuid, ESP_GATT_PERM_READ, CHAR_DECLARATION_SIZE, CHAR_DECLARATION_SIZE, (uint8_t *)&char_prop_read_write}},
    [IDX_CHAR_BRILLO_VAL] = {{ESP_GATT_AUTO_RSP}, {ESP_UUID_LEN_16, (uint8_t *)&GATTS_CHAR_UUID_BRILLO, ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE, 1, sizeof(current_brightness), (uint8_t *)&current_brightness}},
    [IDX_CHAR_MODO_DECL] = {{ESP_GATT_AUTO_RSP}, {ESP_UUID_LEN_16, (uint8_t *)&character_declaration_uuid, ESP_GATT_PERM_READ, CHAR_DECLARATION_SIZE, CHAR_DECLARATION_SIZE, (uint8_t *)&char_prop_read_write}},
    [IDX_CHAR_MODO_VAL] = {{ESP_GATT_AUTO_RSP}, {ESP_UUID_LEN_16, (uint8_t *)&GATTS_CHAR_UUID_MODO, ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE, 1, sizeof(current_mode), (uint8_t *)&current_mode}},
    [IDX_CHAR_WHITE_DECL] = {{ESP_GATT_AUTO_RSP}, {ESP_UUID_LEN_16, (uint8_t *)&character_declaration_uuid, ESP_GATT_PERM_READ, CHAR_DECLARATION_SIZE, CHAR_DECLARATION_SIZE, (uint8_t *)&char_prop_read_write}},
    [IDX_CHAR_WHITE_VAL] = {{ESP_GATT_AUTO_RSP}, {ESP_UUID_LEN_16, (uint8_t *)&GATTS_CHAR_UUID_WHITE, ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE, // Permisos
                                        ...
                                        esp_ble_gatts_cb_param_t *param)
{
    ...
    case ESP_GATTS_CONNECT_EVT:
    {
        ...
        if (user_callbacks.on_connect)
            user_callbacks.on_connect();
    ...
    case ESP_GATTS_DISCONNECT_EVT:
        ...
        if (user_callbacks.on_disconnect)
            user_callbacks.on_disconnect();
        esp_ble_gap_start_advertising(&adv_params);
        break;
    ...
    case ESP_GATTS_CREAT_ATTR_TAB_EVT:
    {
        if (param->add_attr_tab.status != ESP_GATT_OK)
            break;
        if (param->add_attr_tab.num_handle != FOCO_IDX_NB)
            break;
